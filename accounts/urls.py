...
urlpatterns = [
    ...
    path("change-password/", auth_views.PasswordChangeView.as_view(template_name='accounts/change_password.html', success_url='/accounts/dashboard/'), name="change_password"),
